...
// オーバーロードコンストラクタ
//=========================================================
CMyEffect::CMyEffect(int nPriority) : CBillboard(nPriority),
m_nLife(NULL),
m_fRadius(NULL),
m_move(VECTOR3_NULL)
{
...
{
	// エフェクトポインタ
	CMyEffect* pEffect = new CMyEffect;
