...
HRESULT CAnimationObject2D::Init(void)
{
	...
	// 頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(m_pos.x - m_fWidth * 0.5f, m_pos.y - m_fHeight * 0.5f, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(m_pos.x + m_fWidth * 0.5f, m_pos.y - m_fHeight * 0.5f, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(m_pos.x - m_fWidth * 0.5f, m_pos.y + m_fHeight * 0.5f, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(m_pos.x + m_fWidth * 0.5f, m_pos.y + m_fHeight * 0.5f, 0.0f);
...
void CAnimationObject2D::SetTexMoveU(const int& nMaxFream)
{
	...
	//テクスチャ座標の設定
	pVtx[0].tex = D3DXVECTOR2(fLeftU, 0.0f);
	pVtx[1].tex = D3DXVECTOR2(fRightU, 0.0f);
	pVtx[2].tex = D3DXVECTOR2(fLeftU, m_fTexV);
	pVtx[3].tex = D3DXVECTOR2(fRightU, m_fTexV);
...
void CAnimationObject2D::SetTexMoveV(const int& nMaxFream)
{
	...
	//テクスチャ座標の設定
	pVtx[0].tex = D3DXVECTOR2(0.0f, fTopV);
	pVtx[1].tex = D3DXVECTOR2(m_fTexU, fTopV);
	pVtx[2].tex = D3DXVECTOR2(0.0f, fBottomV);
	pVtx[3].tex = D3DXVECTOR2(m_fTexU, fBottomV);
