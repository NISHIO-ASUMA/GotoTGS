...
public:
	...
	// 静的メンバ関数
	static CEffect* Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, D3DXVECTOR3 move, D3DXCOLOR col, int nLife, float fRadius, int nPriority = static_cast<int>(CObject::PRIORITY::EFFECT), TYPE type = TYPE_NONE);
