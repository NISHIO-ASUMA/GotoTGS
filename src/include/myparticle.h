...
// パーティクルクラスを定義
//*********************************************************
class CMyParticle : public CObject
{
public:

	CMyParticle(int nPriority = static_cast<int>(CObject::PRIORITY::UI));
	~CMyParticle();
...
private:
	...
	std::vector<CMyEffect*> m_pEffect; // エフェクト配列
